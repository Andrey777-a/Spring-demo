...
//                .csrf().disable()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/v1/users").hasAuthority(ADMIN.getAuthority())
                        .requestMatchers(HttpMethod.GET,"/users", "/users/{id}").hasAnyAuthority(USER.getAuthority(), ADMIN.getAuthority())
